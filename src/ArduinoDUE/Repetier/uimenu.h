...
UI_MENU_CHANGEACTION(ui_menu_cext_pgain,   UI_TEXT_EXTR_PGAIN,   UI_ACTION_PID_PGAIN,ADVANCED_MODE);
UI_MENU_CHANGEACTION(ui_menu_cext_igain,   UI_TEXT_EXTR_IGAIN,   UI_ACTION_PID_IGAIN,ADVANCED_MODE);
UI_MENU_CHANGEACTION(ui_menu_cext_dgain,   UI_TEXT_EXTR_DGAIN,   UI_ACTION_PID_DGAIN,ADVANCED_MODE);
UI_MENU_CHANGEACTION(ui_menu_cext_dmin,    UI_TEXT_EXTR_DMIN,    UI_ACTION_DRIVE_MIN,ADVANCED_MODE);
UI_MENU_CHANGEACTION(ui_menu_cext_dmax,    UI_TEXT_EXTR_DMAX,    UI_ACTION_DRIVE_MAX,ADVANCED_MODE);
...
//version
#define UI_VERSION_STRING_FULL  VERSION_MAJOR "." VERSION_MINOR_YEAR "-" VERSION_MINOR_MONTH "-" VERSION_MINOR_DAY "_" VERSION_BUILD "." DAVINCI_TYPE
...
#if FEATURE_AUTOLEVEL
UI_MENU_ACTIONCOMMAND(ui_menu_autolevel_setting,UI_TEXT_AUTOLEVEL_SETTING,UI_ACTION_AUTOLEVEL_ON,ADVANCED_MODE);
#define UI_AUTOLEVEL_SETTING_ENTRY ,&ui_menu_autolevel_setting
#define UI_AUTOLEVEL_SETTING_COUNT 1
#else
#define UI_AUTOLEVEL_SETTING_ENTRY 
#define UI_AUTOLEVEL_SETTING_COUNT 0
#endif
...
#define UI_MENU_POSITIONS_SIZE_SETTINGS {UI_MENU_ADDCONDBACK &ui_menu_x_length,&ui_menu_y_length,&ui_menu_z_length UI_AUTOLEVEL_SETTING_ENTRY ,&ui_menu_x_min,&ui_menu_y_min,&ui_menu_z_min}
UI_MENU(ui_menu_positions_size_seetings,UI_MENU_POSITIONS_SIZE_SETTINGS,6+UI_AUTOLEVEL_SETTING_COUNT+UI_MENU_BACKCNT);
...
UI_MENU_ACTIONCOMMAND_FILTER(ui_menu_sd_stop,      UI_TEXT_STOP_PRINT,     UI_ACTION_SD_STOP,     MENU_MODE_SD_PRINTING|MENU_MODE_PRINTING, 0,ALL_MODE);
...
UI_MENU_ACTION4C(ui_menu_extrtemp,UI_ACTION_EXTRUDER0_TEMP,"Temp. 0  :%E0\002C","","","",ALL_MODE);
