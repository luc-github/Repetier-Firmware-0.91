...
#define UI_TEXT_EXTR_WAIT_RETRACT_TEMP "Wait T.:%XT\002C"
...
#define UI_TEXT_STEPPER_INACTIVE2 "Des. Apres:%is","[s] 0=OFF"
#define UI_TEXT_POWER_INACTIVE    "Arret Alim."
#define UI_TEXT_POWER_INACTIVE2   "Des. Apres:%ip","[s] 0=OFF"
#define UI_TEXT_GENERAL           "General"
#define UI_TEXT_BAUDRATE          "Baudrate:%oc"
